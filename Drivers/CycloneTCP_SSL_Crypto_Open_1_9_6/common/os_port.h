...
#include "../../CycloneTCP_SSL_Crypto_Open_1_9_6/common/compiler_port.h"
...
//No RTOS?
   ...
   #include "../../CycloneTCP_SSL_Crypto_Open_1_9_6/common/os_port_none.h"
//ChibiOS/RT port?
#elif defined(USE_CHIBIOS)
   #include "os_port_chibios.h"
//CMSIS-RTOS port?
#elif defined(USE_CMSIS_RTOS)
   #include "../../CycloneTCP_SSL_Crypto_Open_1_9_6/common/os_port_cmsis_rtos.h"
//CMSIS-RTOS2 port?
